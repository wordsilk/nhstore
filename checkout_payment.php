...
define('TEXT_SELECTED_BILLING_DESTINATION', 'Please select a billing address from your address book.');
...
define('TABLE_HEADING_COMMENTS', 'Your Departure Date, Comments, APT Booking Number');
