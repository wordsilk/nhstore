...
define('TEXT_SUCCESS', 'Your order has been successfully processed! Your products will arrive at their destination according to the shipping method you selected. <strong> %s</strong>.'); //rmh M-S_fixes
...
define('TEXT_THANKS_FOR_SHOPPING', 'Thanks for shopping with us online! Your Order Number is: '); //rmh M-S_multi-stores
